...
def main():
    ...
    with conn:
        ...
        PatientImage = (sys.argv[2], sys.argv[3],sys.argv[4], sys.argv[5], sys.argv[6],sys.argv[7], buffer(summimg_raw), sys.argv[9], sys.argv[10], sys.argv[11], sys.argv[12],sys.argv[13], sys.argv[14], sys.argv[15],sys.argv[16], sys.argv[17], sys.argv[18], sys.argv[19], sys.argv[20], sys.argv[21]);
